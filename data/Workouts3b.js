var Workout3bJSON = [
    ...
    ["","Day 1","","S x R","RPE","Strength Stop","","Day 2",null,"S x R","RPE","Strength Stop","","Day 3","","S x R","RPE","Strength Stop","","Day 4",null,"S x R","RPE","Strength Stop"  ],
    ...
    ["","Med Ball","","3 x 6","","","","UB Vert Pull",null,"#","9","","","RFD Unload 2","","3 x 5","","","","UB Hor Pull",null,"6","9","10"  ],
    ["","Squat","","3","7","8","","UB Hor Pull",-1,"4 x 8","8-9","","","Hinge","","3","7","8","","UB Hor Push",-1,"4 x 6","8-9",""  ],
    ["","Hinge","-1","4 x 6","7","","","UB Vert Push",-1,"4 x 6","8-9","","","LB Uni Push","","4","7","8","","UB Vert Pull",-1,"4 x #","8-9",""  ],
...
for (var W = 1; W <= 4; W++) {
  for (var D = 1; D <= 4; D++) {
      TemplateNum ++;
      if (!(W in Workouts3b.getID)) {
          Workouts3b.getID[W] = {}
          Workouts3b.getID[W][D] = TemplateNum;
      }
      else {
        Workouts3b.getID[W][D] = TemplateNum;
      }
      Workouts3b.Templates[W][D] = {
          ID: TemplateNum,
          Week: W,
          Day: D,
          NPatterns: 0,
      ...
      Workouts3b.getWeekDay[TemplateNum] = {Week: W, Day: D};
  }
}
for (var D = 1; D <= 3; D++) {
    TemplateNum ++;
...
Workout3bJSON.forEach(elem => {
    ...
    for (var i = 0; i < AllDays.length; i ++) {
        ...
        if (AllDays[0][0].includes("Week") || AllDays[0][0].includes("Day") || dayRow[0] == "") {
            ...
            Workouts3b.Templates[thisWeek][thisDay].NPatterns ++;
            var PatternNum = Workouts3b.Templates[thisWeek][thisDay].NPatterns;
            var PatternDict = {
                ExerciseType: dayRow[0],
            };
            //     if (item[0] != "") {
            var refDict = {};
            ...
            // if (thisSpecial == "Strength Stop") {

            // }
            // else if (thisSpecial == "Alloy") {
            ...
            if (refDict["SxR"].includes("x") || refDict["SxR"].includes("X")) {
                ...
                // SETS AND REPS
                if (refDict["EType"] == "Carry") {
                    if (Reps.includes(":")) {
                        PatternDict.Reps = parseInt(Reps.trim().slice(1));
                        PatternDict.Seconds = parseInt(Reps.trim().slice(1));
                    }
                    else {
                        PatternDict.Reps = parseInt(Reps.trim());
                        PatternDict.Seconds = parseInt(Reps.trim());
                    }
                }
                if (Reps.trim() ==  "#") {
            ...
            if (refDict["Special"] != "") {
                if (specialsList[dayNum - 1] == "Strength Stop") {
                    ...
                    PatternDict.Reps = parseInt(refDict["SxR"]);
                    PatternDict.Sets = 1;
                }
            ...
            Workouts3b.Templates[thisWeek][thisDay].Patterns[PatternNum] = PatternDict;
