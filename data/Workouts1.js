		...
		1: {
			1: {
				...
				Patterns: {
					...
					3: {ExerciseType: "Hinge", Sets: 3, Reps: 12, RPE: 7, Deload: -1},
					4: {ExerciseType: "UB Hor Pull", Sets: 3, Reps: 12, RPE: 7, Deload: -1},
					5: {ExerciseType: "Ant Chain", Sets: 3, Type: "bodyweight", Reps: null, RPE: 7}, //Not all...
				}
			},
			2: {
				ID: 2,
		...
		4: {
			1: {
				...
				Patterns: {
					...
					3: {ExerciseType: "Ant Chain", Sets: 2, Reps: null, RPE: "5-6",},		
			...
			2: {
				...
				Patterns: {
					...
					5: {ExerciseType: "Post Chain", Sets: 2, Reps: null, RPE: "5-6"}
				}
			},
			3: {
				ID: 12,
